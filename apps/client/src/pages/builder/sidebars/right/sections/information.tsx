  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built TechCV mostly by myself during my spare time, with a lot of help from
    ...
    <CardFooter>
      <a
        ...
        target="_blank"
      >
        <HandHeart size={14} weight="bold" className="me-2" />
        <span className="line-clamp-1">{t`Donate to TechCV`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    ...
    <CardFooter className="gap-4">
      <a
        ...
        target="_blank"
      >
        <GithubLogo size={14} weight="bold" className="me-2" />
      ...
      <a className={cn(buttonVariants({ size: "sm" }))} href="mailto:hello@amruthpillai.com">
        <EnvelopeSimpleOpen size={14} weight="bold" className="me-2" />
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for TechCV, and
    ...
    <CardFooter className="gap-4">
      <a
        ...
        rel="noopener noreferrer nofollow"
      >
        <Book size={14} weight="bold" className="me-2" />
